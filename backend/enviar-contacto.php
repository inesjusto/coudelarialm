...
try {
    ...
    $sql = "INSERT INTO clientes 
                (nome, email, telefone, mensagem, tipo_interesse, estado)
            VALUES 
                (:nome, :email, :telefone, :mensagem, :tipo_interesse, :estado)";
    ...
    $mail->setFrom(
        'coudelarialimamonteiro@gmail.com',
        'Website Coudelaria Lima Monteiro'
    );
    ...
    <div style='background:#24283B; border:1px solid rgba(255,255,255,0.08); border-radius:18px; overflow:hidden;'>
        ...
        <div style='padding:34px 30px; text-align:center; background:#171B2B;'>
            ...
            <h1 style='margin:0; color:#FFFFFF; font-size:26px;'>
                Coudelaria 
                <span style='color:#00C853;'>Lima Monteiro</span>
            </h1>
